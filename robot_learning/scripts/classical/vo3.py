...
class ClassicalVO(object):
    ...
    def proc_f2f(self, 
        ...
        if ref == 0:
            ...
            pt3, msk3, (o_pt21, o_pt20, o_idx), (o_R, o_t) = res
            ...
            # msk3 is fine.
            return pt3, msk3, (o_pt20, o_pt21, o_idx), (o_R, o_t)
    ...
    def __call__(self, img, dt, ax=None):
        ...
        #rsp_p_all = np.concatenate([rsp_l, rsp_p], axis=0)
